...
public final class PasswordGenerator {
    ...
    /**
     * This method will generate a password depending the use* properties you define. It will use the categories with a
     * probability. It is not sure that all of the defined categories will be used.
     *
