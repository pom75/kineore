...
ALTER TABLE Colab ADD COLUMN isSuperAdmin boolean DEFAULT false;

ALTER TABLE ADMIN RENAME KINE_USER;

ALTER TABLE EVENT
RENAME COLUMN EVENT.idAdmin TO Event.idColab;

ALTER TABLE Colab
RENAME COLUMN Colab.idAdmin TO Colab.idKineUser;